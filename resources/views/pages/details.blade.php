  ...
  <div class="container px-6 pt-4 pb-6">
    ...
    <div class="flex flex-wrap justify-center mb-20 lg:mb-2">
      <div class="justify-between gap-4">
        <div class="mt-4 bg-white shadow-md rounded-xl w-[450px] lg:w-[500px]">
          ...
          <div class="flex items-center justify-between">
            <div class="pt-2 pl-3 text-dark w-fit">
              ...
              <p class="w-[500px] text-sm pr-2 text-gray-600">{{$destination->description}}</p>
                @if ($isCart)
                ...
                @else
                <a href="{{ route('cart', Auth()->user()->id) }}" class="flex items-center px-3 py-2 my-3 mr-3 text-white transition duration-200 ease-in-out w-fit bg-secondary hover:bg-lightgreen hover:text-primary rounded-xl">
                  <i class="text-2xl bi bi-cart4"></i>
